                        ...
                        <div className="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                            <div className="px-4 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div className="grid md:grid-cols-2 md:gap-6">
                                    ...
                                    <div className="mb-5">
                                        <select id="village" name="fk_village_id" value={village} onChange={(e) => setVillage(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    <textarea type="text" name="address" value={address} id="address" onChange={(e) => setAddress(e.target.value)} rows="4" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""></textarea>
                                ...
                                <div className="grid md:grid-cols-2 md:gap-6">
                                    <div className="mb-5">
                                        ...
                                        <input type="date" name="birth" value={birth} onChange={(e) => setBirth(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-4  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                        {
                                            errors.birth && (
                                                <div className="p-4 mt-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                    ...
                                    <div className="mb-5">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-2 md:gap-6">
                                            <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                                {
                                                    sex === 'male' ?
                                                        <input id="bordered-radio-1" type="radio" value="male" name="sex" checked onChange={(e) => setSex(e.target.value)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                        :
                                                        <input id="bordered-radio-1" type="radio" value="male" name="sex" onChange={(e) => setSex(e.target.value)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                }
                                            ...
                                            <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                                {
                                                    sex === 'female' ?
                                                        <input id="bordered-radio-2" type="radio" value="female" name="sex" checked onChange={(e) => setSex(e.target.value)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                        :
                                ...
                                <div className="grid md:grid-cols-2 md:gap-6">
                                    <div className="flex flex-col justify-between">
                                        <label htmlFor="photo" className="block mb-3 text-sm font-medium text-gray-900 dark:text-white">Foto Profil</label>
                                        <div className="flex flex-row justify-between mb-5">
                                            <img src={photo} className="max-h-10 rounded-full" alt="" />
                                            ...
                                            <input type="file" name="photo" id="photo" className="hidden" onChange={handlePhoto} ref={fileInput} />
                                        </div>
                                        {
                                            errors.photo && (
                                                <div className="p-4 mt-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <select id="maritalStatuts" name="marital_status" value={maritalStatus} onChange={(e) => setMaritalStatus(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
