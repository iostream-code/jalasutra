...
const VillageCreate = () => {
    ...
    const successNotification = () => {
        Swal.fire({
            icon: "success",
            title: "Desa baru berhasil ditambahkan.",
    ...
    const storeData = async (e) => {
        ...
        await Api.post('/api/villages', formData)
            .then(() => {
                successNotification()
                navigate('/desa')
            })
                ...
                <form>
                    <div className="mt-6">
                        <div className="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div className="mb-5">
                                <select name="head_village" id="head_village" onChange={(e) => setChief(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option defaultValue={null}>-- Pilih Kepala Desa --</option>
                                    {
                                        users &&
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-5 group">
                                <input type="text" name="region" id="region" onChange={(e) => setRegion(e.target.value)} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
